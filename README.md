...
### 6. Casos de exemplo
Abaixo estão exemplos de execução:
...
### 7. Casos-limite
Situações excepcionais ou de fronteira:
...
Identificação das entidades principais envolvidas no problema:
*   Disciplina.
*   Pré-requisito.
*   Histórico Acadêmico.
...
O problema possui uma lógica de negócio clara que permite ser decomposta de formas completamente distintas nos quatro paradigmas estudados:
...
Possíveis linguagens para cada paradigma e justificativas:
...
*   **Lógico (Prolog):** Não sei o porquê ainda, mas é a mais recomendada para esse tipo de paradigma.
